...

{
  ...
  roadmapFlat: [
    ...
    "ENGL 102", "MSIS 110", "AF 210", "MSIS 301", "BC 230",
    "IMS 200", "IT 111L", "BC 290", "SOCIOL 101", "AF 478",
    "AF 310", "AF 311", "AF 315", "MSIS 212", "IT 110",
    "AF 363", "AF 450", "AF 330", "MGT 303", "ENVSCI 101",
    "AF 470", "MATH 125", "MSIS 310", "PHIL 100", "CLSICS 161",
    "PSYCH 100", "BIOL 101", "ANTH 256", "DANCE 135", "LATAM 100",
...

{
  ...
  creditCap: 16,
  roadmapFlat: [
    "SEMINR 126G", "ART 100", "ENGL 101", "MATH 115", "PSYCH 100",
    "ENGL 102", "ART 101", "ART 208", "BIOL 101", "SPAN 101",
    "IMS 200", "ART 102", "ART 281", "HIST 211", "IT 110",
    "ART 104L", "ART 300", "PHIL 100", "CHEM 111L", "ECON 101",
...

{
  ...
  creditCap: 16,
  roadmapFlat: [
    "SEMINR 126G", "CHEM 115", "CHEM 117", "MATH 140", "ENGL 101",
    "CHEM 116", "CHEM 118", "BIOL 111", "ENGL 102", "ART 100",
    "IMS 200", "CHEM 251", "CHEM 255", "BIOL 112", "SPAN 101",
    "CHEM 252", "CHEM 256", "MATH 141", "BIOL 210", "MSIS 110",
...

{
  ...
  creditCap: 16,
  roadmapFlat: [
    "SEMINR 126G", "CHEM 115", "CHEM 117", "ENGL 101", "MATH 115",
    "CHEM 116", "CHEM 118", "MATH 140", "ENGL 102", "ART 100",
    "IMS 200", "CHEM 251", "CHEM 255", "PHIL 100", "SPAN 101",
    "CHEM 252", "CHEM 256", "MATH 141", "HIST 211", "MUSIC 117",
...

{
  ...
  creditCap: 16,
  roadmapFlat: [
    "SEMINR 126G", "CHEM 115", "CHEM 116", "ENGL 101", "MATH 140",
    "CHEM 117", "CHEM 118", "ART 100", "ENGL 102", "SPAN 101",
    "IMS 200", "CHEM 251", "MATH 141", "BIOL 111", "PHYSIC 181",
    "CHEM 252", "CHEM 256", "CHEM 255", "PHYSIC 113", "PHYSIC 182",
    "CHEM 311", "CHEM 313", "PHYSIC 114", "CHEM 314", "CHEM 354",
    "CHEM 312", "CHEM 369", "CHEM 370", "CHEM 371", "HIST 211",
    "CHEM 379", "CHEM 351", "HIST 175", "CHEM 498", "MATH 242",
    "CHEM 408", "CHEM 499", "ENVSCI 101", "BIOL 210", "AFRSTY 101"
  ],
...
,
  ...
  core: [
    ...
    { name: "Classical Languages – BA Major", subject: "CLSICS", degree: "BA", minCredits: 120, creditCap: 16,
  // 8 semesters x 5 courses (40 total). Each term is 15–16 credits, max cap 16.
  // FYS only in Freshman year; IMS only in Sophomore year.
  // Includes 10+ Greek/Latin courses, a seminar (CLSICS 387/388), and 5+ upper-level (300+) courses.
  roadmapFlat: [
  ...
  required: [
    ...
    { name: "Classical Studies – BA Major", subject: "CLSICS", degree: "BA", minCredits: 120, creditCap: 16,
  // 8 semesters x 5 courses (40 total). Each term is 15–16 credits, max cap 16.
  // FYS only in Freshman year; IMS only in Sophomore year.
  // Includes: 2 semesters of a language (Greek here), 7+ CLSICS courses (seminars included), and 5+ upper-level (300+) courses.
  roadmapFlat: [
    // Freshman Fall (16)
    ...
    // Sophomore Spring (15)
    "CLSICS 301", "CLSICS 320", "SPAN 101", "CHEM 111L", "SOCIOL 101",
    // Junior Fall (15)
    ...
    // Senior Spring (15)
    "CLSICS 284", "SPAN 102", "HIST 371", "ART 101", "ANTH 256"
  ],
  required: [
    "SEMINR 126G", "ENGL 101", "MATH 115", "GREEK 101", "ART 100",
    "ENGL 102", "GREEK 102", "HIST 211", "BIOL 101", "PSYCH 100",
    ...
    { name: "Communication – BA Major", subject: "COMM", degree: "BA", minCredits: 120, creditCap: 16,
      // 8 semesters x 5 courses (40 total). Each term is 15–16 credits, max cap 16.
      // FYS only in Freshman year; IMS only in Sophomore year.
      // Includes COMM core + electives + capstone, plus Distribution II coverage (BA requires 11).
      roadmapFlat: [
        // Freshman Fall (16)
        ...
        // Senior Spring (15)
        "COMM 350", "COMM 480", "DANCE 135", "SPAN 102", "ANTH 256"
      ],
      required: [
        "SEMINR 126G", "COMM 100", "ENGL 101", "MATH 115", "PSYCH 100",
        "ENGL 102", "COMM 105", "COMM 200", "BIOL 101", "SPAN 101",
    ...
    { name: "Community Studies – BA Major", subject: "UPCD", degree: "BA", minCredits: 120, creditCap: 16,
      // 8 semesters x 5 courses (40 total). Each term is 15–16 credits, max cap 16.
      // FYS only in Freshman year; IMS only in Sophomore year.
      roadmapFlat: [
        // Freshman Fall (16)
      ...
      required: [
        "SEMINR 126G",
        "PCSCOR 200", "PCSCOR 220",
        "HUMCTR 371",
        "PCSCOR 325", "PCSCOR 350", "PCSCOR 370",
        "CSTCTR 225", "CSTCTR 250",
        "CSTCTR 300", "CSTCTR 325", "CSTCTR 330", "CSTCTR 335",
        "CSTCTR 370",
        "CSTCTR 400", "CSTCTR 430",
        "CSTCTR 490"
      ]
    },
    { name: "Computer Engineering – BS", subject: "ENGIN", degree: "BS", minCredits: 120, creditCap: 16,
      // 8 semesters x 5 courses (40 total). Each term is 15–16 credits, max cap 16.
      // FYS only in Freshman year; IMS only in Sophomore year.
      roadmapFlat: [
        // Freshman Fall (16)
      ...
      required: [
        "SEMINR 126G",
        "MATH 140", "MATH 141", "MATH 242", "MATH 260",
        "ENGIN 211L",
        "CS 220",
        "PHYSIC 113", "PHYSIC 181", "PHYSIC 114", "PHYSIC 182",
        "CS 110", "CS 210", "CS 240", "CS 310",
        "ENGIN 104",
        "ENGIN 231", "ENGIN 271", "ENGIN 232", "ENGIN 272",
        "ENGIN 241",
        "ENGIN 246",
        "ENGIN 365",
        "ENGIN 321", "ENGIN 322",
    ...
    { name: "Computer Science - BA Major", subject: "CS", degree: "BA", minCredits: 120, creditCap: 16,
      // 8 semesters x 5 courses (40 total). Each term is 15–16 credits, max cap 16.
      // FYS only in Freshman year; IMS only in Sophomore year.
      // Includes CS required courses, required math, required electives, and capstone.
      roadmapFlat: [
        // Freshman Fall (16)
      ...
      required: [
        "SEMINR 126G", "IMS 200",
        "CS 110", "CS 210", "CS 220", "CS 240", "CS 310", "CS 341", "CS 420", "CS 450",
        "MATH 140", "MATH 141", "MATH 260",
        "CS 444",
        "CS 410",
        "MATH 345",
        "CS 430"
    ...
    { name: "Computer Science - BS Major", subject: "CS", degree: "BS", minCredits: 120, creditCap: 16,
      // 8 semesters x 5 courses (40 total). Each term targets 15–16 credits (never >16) given the credit values in allCourses.
      // FYS only in Freshman year; IMS only in Sophomore year.
      // Includes required CS (11), required math (4), required physics w/ labs (2 sets), capstone (CS 410),
      // and CS electives (CS 415, CS 443, plus two from {CS 413, CS 430}).
      roadmapFlat: [
        // Freshman Fall
      ...
      required: [
        "SEMINR 126G", "IMS 200",
        "CS 110", "CS 210", "CS 220", "CS 240", "CS 310", "CS 341", "CS 420", "CS 444", "CS 446", "CS 449", "CS 451",
        "MATH 140", "MATH 141", "MATH 260", "MATH 345",
        "PHYSIC 113", "PHYSIC 181", "PHYSIC 114", "PHYSIC 182",
        "CS 410",
        "CS 415", "CS 443",
        "CS 413", "CS 430"
    ...
    { name: "Criminology and Criminal Justice – BA Major", subject: "CRIM", degree: "BA", minCredits: 120, creditCap: 16,
      // 8 semesters x 5 courses (40 total). Each term is 15–16 credits, max cap 16.
      // FYS only in Freshman year; IMS only in Sophomore year.
      // Includes: core (SOCIOL 101, 104, 202, 262), quant (SOCIOL 350), systems (SOCIOL 337),
      // advanced criminology (SOCIOL 316), capstone (SOCIOL 474), and major electives (SOCIOL 460/461 = 6 credits each).
      roadmapFlat: [
        // Freshman Fall (16)
      ...
      required: [
        "SEMINR 126G", "IMS 200",
        "SOCIOL 101", "SOCIOL 262", "SOCIOL 104", "SOCIOL 202",
        "SOCIOL 350",
        "SOCIOL 337",
        "SOCIOL 316",
        "SOCIOL 474",
        "SOCIOL 460", "SOCIOL 461"
      ]
    },
    { name: "Economics - BA Major", subject: "ECON", degree: "BA", minCredits: 120, creditCap: 16,
      // 8 semesters x 5 courses (40 total). Each term is 15–16 credits, max cap 16.
      // FYS only in Freshman year; IMS only in Sophomore year.
      // Includes core econ sequence, stats (IT 111L), alternative approach electives, 400-level capstone, and 3 additional econ electives.
      roadmapFlat: [
        // Freshman Fall (16)
        "SEMINR 126G", "ECON 101", "ENGL 101", "MATH 115", "ART 100",
        // Freshman Spring (16)
        "ECON 102", "ENGL 102", "IT 111L", "PSYCH 100", "SPAN 101",
        // Sophomore Fall (16)
        "IMS 200", "ECON 201", "MATH 125", "HIST 211", "IT 110",
        // Sophomore Spring (15)
        ...
        // Senior Spring (15)
        "CS 187SL", "CS 188SL", "SPAN 102", "ENGL 135", "MATH 140"
      ],
      required: [
        "SEMINR 126G", "IMS 200",
        ...
        "ECON 214GL", "ECON 308",
        "ECON 420",
        "ECON 318", "ECON 327", "ECON 335"
      ]
    },
    { name: "Electrical Engineering – BS", subject: "ENGIN", degree: "BS", minCredits: 120, creditCap: 16,
      // 8 semesters x 5 courses (40 total). Each term targets 15–16 credits (never >16) given the credit values in allCourses.
      // FYS only in Freshman year; IMS only in Sophomore year.
      // Includes math+ENGIN lab, physics w/ labs, CS, EE core, and major electives listed in the requirement block.
      roadmapFlat: [
        // Freshman Fall (16)
        "SEMINR 126G", "MATH 140", "ENGIN 104", "ENGL 101", "ART 100",
        // Freshman Spring (16)
        "MATH 141", "PHYSIC 113", "PHYSIC 181", "CS 110", "ENGL 102",
        // Sophomore Fall (16)
        "IMS 200", "MATH 242", "ENGIN 231", "ENGIN 211L", "IT 110",
        // Sophomore Spring (15)
        "MATH 260", "MATH 270", "ENGIN 271", "ENGIN 232", "ENGIN 272",
        // Junior Fall (15)
        "PHYSIC 114", "PHYSIC 182", "CS 240", "ENGIN 241", "PHIL 100",
        // Junior Spring (15)
        "ENGIN 365", "ENGIN 366", "ENGIN 321", "ENGIN 322", "SOCIOL 101",
        // Senior Fall (15)
        "ENGIN 331", "ENGIN 342", "ENGIN 351", "ENGIN 344", "AFRSTY 101",
        // Senior Spring (15)
      ...
      required: [
        "SEMINR 126G", "IMS 200",
        // Math + lab
        "MATH 140", "MATH 141", "MATH 242", "MATH 260", "MATH 270", "ENGIN 211L",
        // Physics w/ labs
        "PHYSIC 113", "PHYSIC 181", "PHYSIC 114", "PHYSIC 182",
        // CS
        "CS 110", "CS 240",
        ...
        "ENGIN 331",
        "ENGIN 491", "ENGIN 492",
        // Major electives (listed)
        "ENGIN 342", "ENGIN 351", "ENGIN 435", "ENGIN 471",
        "ENGIN 344", "ENGIN 353",
        "ENGIN 442", "ENGIN 451"
      ]
    },
    { name: "Entrepreneurship - BS Major", subject: "BUSADM", degree: "BS", minCredits: 120, creditCap: 16,
      // 8 semesters x 5 courses (40 total). Each term is 15–16 credits max (never >16) based on course credits.
      // FYS only in Freshman year; IMS only in Sophomore year.
      // Business core + Entrepreneurship requirements + electives + capstone per your list.
      roadmapFlat: [
        // Freshman Fall (16)
...

{
  ...
  roadmapFlat: [
    ...
    // Freshman Spring (15)
    "ENGL 102", "EHS 120", "EHS 160", "PSYCH 100", "CHEM 111L",
    // Sophomore Fall (16)
    ...
    // Senior Spring (15)
    "EHS 491", "EHS 400", "MATH 125", "BIOL 111"
  ],
  ...
  core: [
    ...
    { name: "Finance - BS Major", subject: "AF", degree: "BS", minCredits: 120, creditCap: 16,
      roadmapFlat: [
        // Freshman Fall (16)
        ...
        // Sophomore Fall (16)
        "IMS 200", "IT 111L", "AF 211", "HIST 211", "IT 110",
        // Sophomore Spring (15)
        "AF 301", "MSIS 212", "MGT 303", "PHIL 100", "BIOL 101",
        // Junior Fall (15)
...
core: [
    ...
    { name: "Marketing Major - BS Major", subject: "MKT", degree: "BS", minCredits: 120, creditCap: 16,
      roadmapFlat: [
        // Freshman Fall (15)
        "SEMINR 126G", "ENGL 101", "MATH 115", "ECON 101", "ART 100",
        // Freshman Spring (15)
        ...
        "AF 301", "MSIS 212", "MGT 303", "PHIL 100", "BIOL 101",
        // Junior Fall (15)
        "MGT 330", "MGT 331", "MSIS 301", "MKT 310", "CHEM 111L",
        // Junior Spring (15)
...
core: [
  ...
  roadmapFlat: [
    ...
    // Sophomore Fall (16)
    "IMS 200", "HIST 211", "PHIL 100", "CHEM 111L", "MUSIC 117",
    // Sophomore Spring (16)
    "FRENCH 102", "SOCIOL 101", "AFRSTY 101", "ENVSCI 101", "THRART 122",
    // Junior Fall (16)
    "FRENCH 201", "POLSCI 102", "CLSICS 161", "MATH 125", "LATAM 101",
    // Junior Spring (16)
    "FRENCH 202", "FRENCH 301", "ANTH 106", "DANCE 135", "MUSIC 117",
    // Senior Fall (15)
    "FRENCH 302", "FRENCH 303", "FRENCH 411", "FRENCH 374L", "FRENCH 360",
    // Senior Spring (15)
    "FRENCH 440", "FRENCH 377L", "FRENCH 465", "FRENCH 498", "FRENCH 499"
  ],

  major: [
    "FRENCH 101", "FRENCH 102", "FRENCH 201", "FRENCH 202",
    "FRENCH 301", "FRENCH 302", "FRENCH 303", "FRENCH 411",
  ...
  roadmapFlat: [
    ...
    // Freshman Spring (16)
    "ENGL 102", "HIST 150", "PSYCH 100", "BIOL 101", "SPAN 101",
    // Sophomore Fall (16)
    "IMS 200", "HIST 211", "PHIL 100", "CHEM 111L", "IT 110",
    // Sophomore Spring (15)
    "HIST 152", "HIST 214", "ECON 101", "AFRSTY 101", "ENVSCI 101",
    // Junior Fall (15)
    "HIST 302L", "HIST 304", "SOCIOL 101", "CLSICS 161", "LATAM 101",
    // Junior Spring (15)
  ...
  roadmapFlat: [
    ...
    // Sophomore Spring (15)
    "AF 301", "MSIS 212", "MKT 301", "HIST 211", "BIOL 101",
    // Junior Fall (15)
    "MSIS 301", "MSIS 310", "IT 230L", "MGT 330", "PHIL 100",
    // Junior Spring (15)
    "IT 370", "IT 471", "IT 425L", "MGT 331", "SOCIOL 101",
    // Senior Fall (15)
  ...
  roadmapFlat: [
    ...
    "ENGL 102", "MSIS 110", "AF 210", "BC 290", "SPAN 101",
    // Sophomore Fall
    "IMS 200", "IT 111L", "AF 211", "MGT 303", "HIST 211",
    // Sophomore Spring
  ...
  roadmapFlat: [
    ...
    "ENGL 102", "MSIS 110", "AF 210", "BC 290", "SPAN 101",
    // Sophomore Fall (16)
    "IMS 200", "IT 111L", "AF 211", "ECON 102", "HIST 211",
    // Sophomore Spring (15)
    "AF 301", "MSIS 212", "MGT 303", "PHIL 100", "BIOL 101",
    // Junior Fall (15)
...

{
  ...
  // Only these majors should show/enable Track/Concentration searching
  const majorsWithTracks = new Set([
  ...
  // Demo tracks (you can expand later)
  const demoTracksByMajor = {
    "Information Technology": [
    ...
    "Mathematics": ["Applied Math", "Statistics", "Pure Math"],
    "Biology": ["Cell & Molecular", "Ecology & Evolution", "Pre-Health"],
    "Psychology": ["Clinical", "Cognitive", "Developmental", "Social"],
    "Exercise & Health Sciences": ["Exercise Science", "Health Promotion"],
    "Business / Management": ["Finance", "Marketing", "Management", "Supply Chain"],
  };
