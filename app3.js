...
},
{
  ...
  roadmapFlat: [
    // Freshman Fall (16)
    "SEMINR 126G", "ENGL 101", "MATH 115", "IT 110", "ECON 101",
    // Freshman Spring (16)
    "ENGL 102", "IT 111L", "IT 114L", "IT 116", "ECON 102",
    // Sophomore Fall (15)
    "IMS 200", "IT 230L", "IT 240", "IT 244", "ART 100",
    // Sophomore Spring (15)
    "IT 246", "IT 285L", "MATH 125", "SPAN 101", "HIST 175",
    // Junior Fall (15)
    "IT 341", "IT 360", "IT 220", "IT 370", "BC 290",
    // Junior Spring (15)
    "IT 425L", "IT 428L", "IT 456", "IT 461L","SPAN 102",
    // Senior Fall (15)
    "IT 460", "HIST 211", "AF 210", "BIOL 101", "SOCIOL 262",
    // Senior Spring (16)
    "IT 485", "AF 211", "POLSCI 202", "ANTH 106", "PSYCH 100"
  ],
  ...
  roadmapFlat: [
    ...
    // Junior Spring (15)
    "IT 425L", "IT 428L", "IT 456", "IT 461L", "HIST 175",
    // Senior Fall (15)
    "IT 460", "IT 471", "AF 210", "AFRSTY 101", "SOCIOL 262",
    // Senior Spring (16)
    "IT 485", "AF 211", "POLSCI 102", "ANTH 106", "POLSCI 202"
  ],
...

{
  ...
  roadmapFlat: [
    ...
    // Sophomore Spring (15-16)
    "AF 301", "MGT 303", "SPAN 101", "IT 110", "ECON 102",
...

{
  ...
  { code:"IMS 200", title:"Intermediate Seminar Requirement", credits:4, difficulty:"Easy", type:["IMS","Intermediate Seminar"], prereqs:[] },
...
{ subject: "ASP", code: "ASP 120", title: "Introduction to Peer Tutoring", credits: 1, difficulty: "Easy", prereqs: [] },
{ subject: "ASP", code: "ASP 301", title: "Peer Educator Seminar", credits: 3, difficulty: "Moderate", prereqs: [] },

{ subject: "CRW", code: "CRW 111", title: "Critical Thinking I", credits: 3, difficulty: "Easy", prereqs: [] },
{ subject: "CRW", code: "CRW 112", title: "Critical Thinking II", credits: 3, difficulty: "Easy", prereqs: [] },
{ subject: "CRW", code: "CRW 282", title: "Elements of Writing Proficiency", credits: 3, difficulty: "Moderate", prereqs: [] },

{ subject: "FOUN", code: "FOUN 100", title: "Strategies of Foundational Learning", credits: 1, difficulty: "Easy", prereqs: [] },
{ subject: "FOUN", code: "FOUN 101", title: "Planning for Career and Financial Success", credits: 1, difficulty: "Easy", prereqs: [] },

{ subject: "INTR-D", code: "INTR-D 100G", title: "Special Topics First Year Seminar", credits: 1, difficulty: "Easy", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 110", title: "Set SAIL for Success Course Part I", credits: 1, difficulty: "Easy", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 111", title: "Sail Success Course Part II", credits: 1, difficulty: "Easy", prereqs: []},
{ subject: "INTR-D", code: "INTR-D 120", title: "CSM Freshman Transition Seminar", credits: 1, difficulty: "Easy", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 121", title: "CSM Freshman Transition Seminar II", credits: 1, difficulty: "Easy", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 135", title: "Connected Futures", credits: 1, difficulty: "Easy", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 170", title: "UTeach Step 1: Inquiry Approaches to Teaching", credits: 1, difficulty: "Easy", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 175", title: "UTeach Step 2: Inquiry-Based Lesson Design", credits: 1, difficulty: "Moderate", prereqs: ["INTR-D 170"] },
{ subject: "INTR-D", code: "INTR-D 187S", title: "Science Gateway Seminar I", credits: 2, difficulty: "Easy", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 188S", title: "Science Gateway Seminar II", credits: 2, difficulty: "Easy", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 200G", title: "Special Topics Intermediate Seminar", credits: 3, difficulty: "Moderate", prereqs: ["ENGL 102"] },
{ subject: "INTR-D", code: "INTR-D 280", title: "Special Topics", credits: 1, difficulty: "Moderate", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 291", title: "PACE Success: for students working in an on-campus apprenticeship", credits: 3, difficulty: "Moderate", prereqs: [] },
{ subject: "INTR-D", code: "INTR-D 480", title: "Special Topics", credits: 3, difficulty: "Hard", prereqs: [] },
  ...
  (function enforceAccountingCreditCap(){
    try{
      ...
      m.required = out.slice();
    }catch(e){}
  })();


  // Normalize all catalog courses so every subject-search result can be added
  // and counted correctly in the Workload Analysis meter.
  allCourses.forEach(c => {
    if(!c || !c.code) return;

    if(typeof c.credits !== 'number') {
      const parsedCredits = parseFloat(c.credits);
      c.credits = Number.isFinite(parsedCredits) ? parsedCredits : 0;
    }
    ...
    const detectedSubject = getSubjectFromCourseCode(c.code, c);
    if(detectedSubject && !c.type.includes(detectedSubject)) {
      c.type.unshift(detectedSubject);
    }
  });
...
// =====================================================
const FIRST_YEAR_SEMINAR_CODES = new Set(["AFRSTY 115G", "AMST 110G", "ANTH 112G", "ANTH 113G", "BUSADM 120G", "CINE 121G", "ECHD 101G", "ECON 110G", 
  "ENGL 125G", "ENGL 126G", "ENGL 127G", "ENGL 181G", "ENGL 183G", "ENGL 185G", "ENGL 186G", "ENGL 187G", "ENVSCI 179G", "LABOR 111G", "MUSIC 105G", 
  "PHIL 130G", "POLSCI 113G", "PSYCH 131G", "RELSTY 115G", "SEMINR 114G", "SEMINR 120G", "SOCIOL 110G", "SOCIOL 120G", "SPAN 160G", "WGS 120G"]);
...
const ARTS_SUBJECT_CODES = new Set([
  "AFRSTY 122", "AFRSTY 224L", "AFRSTY 270", "AMST 235", "AMST 278L", "ART 100", "ART 101", "ART 102", "ART 199", "ART 213L", "ART 229", "ART 235", "ART 250", "ART 252", "ART 278L", "ART 281", "ART 283", "ART 286", "ART 287", "ART 293L", "ART 295L", "ART 317", "ART 318L", "ART 375", "CHINSE 276", "CINE 101", "CINE 213L", "CINE 260L", "CINE 293L", "CINE 295L", "CINE 318L", "CINE 320", "CINE 350", "CINE 372L", "CLSICS 286", "CLSICS 383", "DANCE 130", "DANCE 131", "DANCE 132", "DANCE 133", "DANCE 134", "DANCE 135", "DANCE 232", "DANCE 233", "DANCE 234", "DANCE 330", "ENGL 110", "ENGL 124", "ENGL 126", "ENGL 200", "ENGL 210", "ENGL 225", "HONORS 291", "ITAL 270", "MUSIC 111", "MUSIC 115", "MUSIC 117", "MUSIC 121", "MUSIC 122", "MUSIC 200", "MUSIC 221", "MUSIC 222", "MUSIC 300", "MUSIC 302", "MUSIC 303", "THRART 100", "THRART 123", "THRART 136", "THRART 236", "THRART 251", "THRART 260L", "THRART 336", "THRART 337", "THRART 361", "WGS 200", "WGS 224L"
]);

const missingArtsCourses = [
  { code:"AFRSTY 122", title:"Black Cinema: American Myth, Racial Ideology, and Hollywood", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"AFRSTY 224L", title:"Contemporary Transatlantic Women's Novels: Aesthetics and Black Womanhood", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"AFRSTY 270", title:"The Black Image on Stage and Screen", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"AMST 235", title:"The Social History of Popular Music", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"AMST 278L", title:"U.S. Documentary Photography", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 199", title:"Visual Thinking", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 213L", title:"The Art of Editing", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 229", title:"American Prints, Politics, and Popular Culture", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 235", title:"History of Global Design", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 250", title:"Art of the Twentieth Century", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 252", title:"American Art in Boston", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 278L", title:"U.S. Documentary Photography", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 283", title:"Introduction to the Materials, Techniques and Concepts of Painting", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 286", title:"Materials, Processes, and Ideas: Introduction to Contemporary Sculptural Practices", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 287", title:"Introduction to Printmaking", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 293L", title:"Photography I", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 295L", title:"Introduction to Video", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 317", title:"Nineteenth-Century Art in Europe and the United States", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 318L", title:"Women and Experimental Cinema", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ART 375", title:"Contemporary Art: c. 1989-Present", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CHINSE 276", title:"Modern Chinese Cinema", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CINE 101", title:"Introduction to Cinema Studies", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CINE 213L", title:"The Art of Editing", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CINE 260L", title:"Improvisation and the Art of Comedy", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CINE 293L", title:"Photography I", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CINE 295L", title:"Introduction to Video", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CINE 318L", title:"Women and Experimental Cinema", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CINE 320", title:"Film Directors", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CINE 350", title:"Film Genres", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CINE 372L", title:"German Cinema", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CLSICS 286", title:"Greek and Roman Comedy", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"CLSICS 383", title:"Heroes, Wars and Quests", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"DANCE 130", title:"Understanding Dance", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"DANCE 131", title:"Musical Theatre Dance", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"DANCE 132", title:"Ballet I", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"DANCE 133", title:"Jazz Dance I", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"DANCE 134", title:"Modern Dance I", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"DANCE 232", title:"Ballet II", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"DANCE 233", title:"Jazz Dance II", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"DANCE 234", title:"Modern Dance II", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"DANCE 330", title:"The Pedagogy of Dance", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ENGL 110", title:"Reading Like a Writer", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ENGL 124", title:"Science Fiction: Cross-Cultural Perspectives", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ENGL 126", title:"Young Adult Literature", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ENGL 200", title:"Introduction to Literary Studies", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ENGL 210", title:"Introduction to Creative Writing", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ENGL 225", title:"Graphic Novels", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"HONORS 291", title:"Honors Topic in Arts", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"ITAL 270", title:"Dante's Divine Comedy", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"MUSIC 111", title:"An Introduction to Music", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"MUSIC 115", title:"World Music", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"MUSIC 200", title:"Masterpieces of Western Art Music", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"MUSIC 221", title:"Theory III", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"MUSIC 222", title:"Theory IV", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"MUSIC 300", title:"Masterpieces of Western Music for Music Minors", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"MUSIC 302", title:"Medieval to Baroque", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"MUSIC 303", title:"Classical to Modern", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"THRART 100", title:"Introduction to Theatre", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"THRART 123", title:"Theatre Crafts I", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"THRART 136", title:"Introduction to Acting", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"THRART 236", title:"Acting 1", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"THRART 251", title:"Playwriting I", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"THRART 260L", title:"Improvisation and the Art of Comedy", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"THRART 336", title:"Acting 2", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"THRART 337", title:"Directing I", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"THRART 361", title:"Introduction to Costume Design", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"WGS 200", title:"Feminist Literature in the US: An Intersectional Approach", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] },
  { code:"WGS 224L", title:"Contemporary Transatlantic Women's Novels: Aesthetics and Black Womanhood", credits:3, difficulty:"Moderate", prereqs:[], type:["AR"] }
];

const HUMANITIES_SUBJECT_CODES = new Set([
"AFRSTY 110","AFRSTY 111","AFRSTY 230L","AFRSTY 352L","AMST 100","AMST 101","AMST 201L","AMST 206","AMST 325L","ANTH 333L","ART 224","ASAMST 200",
"ASAMST 223L","ASAMST 226","ASAMST 270","CINE 201","CINE 202","CINE 412L","CLSICS 180","CLSICS 218G","CLSICS 242L","CLSICS 284","CLSICS 388",
"EDC U 370","ENGL 201","ENGL 202","ENGL 223L","ENGL 236","ENGL 351","ENGL 352L","HIST 155","HIST 185","HIST 186","HIST 211","HIST 212","HIST 265",
"HIST 266","HIST 314","HIST 378","HONORS 292","ITAL 267","LATAM 101","LATAM 160","LATAM 262L","LATSTY 201L","LATSTY 223L","PHIL 100","PHIL 108",
"PHIL 150","PHIL 208","PHIL 212","PHIL 215","PHIL 216","PHIL 218","PHIL 222","PHIL 225L","PHIL 230","PHIL 255","PHIL 333","PHIL 344","PHIL 346",
"PHIL 347","POLSCI 103","RELSTY 109","RELSTY 225L","RELSTY 242L","SPAN 262L","THRART 109","THRART 201","WGS 150","WGS 220","WGS 230L","WGS 325L",
"WGS 373","WGS 412L","WGS 420"
]);



const SBS_SUBJECT_CODES = new Set([
"ANTH 106","ANTH 107","ANTH 210L","ANTH 230","ANTH 240L","ANTH 243L","ANTH 340","ANTH 353","ASAMST 225L","ASAMST 228L","COMM 100","COMM 250",
"COMM 260","COMM 300","COMM 345L","CS 271L","ECON 101","ECON 102","ECON 201","ECON 202","ECON 334","ECON 335","ECON 336","ECON 390","ECON 395",
"ECON 420","EDC U 270","ENVSCI 105","ENVSCI 122","ENVSTY 120L","ENVSTY 230","ENVSTY 345L","GERON 150","GERON 160","GERON 170","GERON 180","GERON 190",
"GERON 240","GERON 250","GERON 260","GERON 325","GERON 342L","HIST 210L","HIST 214","HIST 324","HONORS 293","LABOR 210L","LABOR 222G","LABOR 240L",
"LABOR 325","LATAM 240L","PHIL 265","POLSCI 101","POLSCI 102","POLSCI 202","PSYCH 100","PSYCH 238L","PSYCH 271L","SOCIOL 101","SOCIOL 160","SOCIOL 230",
"SOCIOL 262","SOCIOL 333L","SOCIOL 342L","SOCIOL 366","SOCIOL 367","SOCIOL 382","UPCD 120L","UPCD 201","UPCD 210","UPCD 301","UPCD 321","UPCD 353L",
"WGS 100","WGS 110","WGS 201","WGS 243L"
]);



const NS_SUBJECT_CODES = new Set([
"ANTH 105","ANTH 211","ANTH 316","ANTH 358","BIOL 101","BIOL 102","BIOL 108","BIOL 111","BIOL 112","BIOL 207","BIOL 208","CHEM 111L","CHEM 115",
"CHEM 116","CHEM 130","CHEM 251","CHEM 252","ENGIN 103","ENVSCI 101","ENVSCI 104","ENVSCI 120","ENVSCI 150L","ENVSCI 225","ENVSCI 226","ENVSCI 260",
"ENVSTY 101","ENVSTY 111L","ENVSTY 150L","HONORS 295","PHYSIC 107","PHYSIC 108","PHYSIC 113","PHYSIC 114","PHYSIC 121","PHYSIC 126","PHYSIC 134"
]);



const WL_SUBJECT_CODES = new Set([
"ARABIC 101","ARABIC 102","ARABIC 201","ARABIC 202","CHINSE 101","CHINSE 102","CHINSE 201","CHINSE 202","CHINSE 301","CHINSE 302","CHINSE 315",
"FRENCH 100","FRENCH 101","FRENCH 102","FRENCH 201","FRENCH 202","FRENCH 301","FRENCH 304","FRENCH 480","FRENCH 498","FRENCH 499","GERMAN 100",
"GERMAN 101","GERMAN 102","GERMAN 200","GREEK 101","GREEK 102","GREEK 211","GREEK 222","ITAL 100","ITAL 101","ITAL 102","ITAL 201","ITAL 301",
"ITAL 498","ITAL 499","JAPAN 100","JAPAN 101","JAPAN 102","JAPAN 201","JAPAN 202","JAPAN 301","JAPAN 302","LATIN 101","LATIN 102","LATIN 201",
"LATIN 202","LATIN 301","LATIN 309","PORT 101","PORT 102","PORT 201","PORT 202","PORT 304","SPAN 101","SPAN 102","SPAN 201","SPAN 202","SPAN 230",
"SPAN 280","SPAN 289","SPAN 301","SPAN 304","SPAN 316","SPAN 317","SPAN 364","SPAN 370","SPAN 408","SPAN 409","SPAN 450","VIET 101","VIET 102"
]);



const WC_SUBJECT_CODES = new Set([
"AFRSTY 101","AFRSTY 225","AFRSTY 343L","AMST 270L","AMST 285L","ANTH 232","ANTH 247","ANTH 260","ANTH 263","ANTH 270L","ANTH 272","ANTH 273",
"ANTH 274","ANTH 279","ANTH 295L","ANTH 343L","ANTH 359","ANTH 361L","ANTH 366","ANTH 367","ARABIC 260L","ART 104L","ASAMST 345","ASAMST 375L",
"ASIAN 104L","ASIAN 112L","ASIAN 115L","ASIAN 155L","ASIAN 215L","ASIAN 233L","ASIAN 239L","ASIAN 251L","ASIAN 280","ASIAN 314L","ASIAN 335L",
"ASIAN 345L","ASIAN 357L","ASIAN 358L","CINE 235L","CINE 341L","CINE 361L","CLSICS 161","CLSICS 230L","CLSICS 239L","CLSICS 281","CLSICS 282",
"CLSICS 285","CLSICS 311L","CLSICS 327L","ENGL 130","ENGL 293L","ENGL 341L","ENVSCI 256","ENVSTY 222L","FRENCH 345L","FRENCH 355L","FRENCH 440",
"GERMAN 225L","GERMAN 255L","GERMAN 345L","HIST 115L","HIST 125L","HIST 161L","HIST 225L","HIST 230L","HIST 251L","HIST 285L","HIST 311L","HONORS 294",
"HUMAN 255L","ITAL 345L","ITAL 355L","JAPAN 367L","LABOR 335","LATAM 360","LATAM 375L","MLLC 155L","MLLC 225L","MLLC 235L","MLLC 255L","MLLC 270",
"MLLC 345L","MLLC 355L","MUSIC 315","PHIL 200","PHIL 297","PORT 375L","RELSTY 111","RELSTY 112L","RELSTY 125L","RELSTY 215L","RELSTY 233L",
"RELSTY 239L","RELSTY 311L","RELSTY 314L","RELSTY 335L","RELSTY 357L","RELSTY 358L","SOCIOL 333L","SOCIOL 355L","WGS 270","WGS 293L","WGS 295L",
"WGS 341L","WGS 345L","WGS 355L","WGS 357L","WGS 360","WGS 411"
]);




missingArtsCourses.forEach(course => {
  if(!allCourses.some(existing => String(existing?.code || "").trim().toUpperCase() === course.code)) {
...
,
  ...
  function getSubjectFromCourseCode(code, courseObj){
    const fromSubjectField = String(courseObj?.subject || "").trim();
    if(fromSubjectField) return fromSubjectField;
    ...
    if(upperRaw.startsWith("EDC U ")) return "EDC U";

    // Normal spaced codes: "IT 110" -> "IT"
    const firstToken = raw.split(/\s+/)[0] || "";
    if(firstToken && /[A-Za-z]/.test(firstToken) && !/\d/.test(firstToken)) return firstToken;

    // Compact codes with no space: "FOUN100", "NAV101", "CRW111"
    const compactMatch = upperRaw.match(/^[A-Z]+/);
  ...
  function normalizeSubjectCode(value){
    ...
    // Display label: "USEA | University Sea-based Skills"
    if(raw.includes("|")) {
      const direct = upper(raw.split("|")[0].trim());
      if(direct) return direct;
    }

    const aliasCode = resolveSubjectAlias(raw);
    if(aliasCode) return aliasCode;

    const up = upper(raw);

    // Exact known subject code from subject catalog line
    if(SUBJECT_DISPLAY_MAP[up]) return up;

    // Two-part subject code support
    if(up.startsWith("EDC U")) return "EDC U";

    // Match by subject display text, e.g. "University Sea-based Skills"
    for(const [code, display] of Object.entries(SUBJECT_DISPLAY_MAP)) {
      const displayUpper = upper(display);
      const nameUpper = upper(display.split("|").slice(1).join("|").trim());
      if(up === code || up === displayUpper || up === nameUpper) return code;
    }

    // Fallback: support two-part subjects like "EDC U 212"
    const twoPart = up.match(/^([A-Z]+\s+[A-Z]+)(?:\s|$)/);
    if(twoPart) return twoPart[1];
    const token = up.split(/\s+/)[0] || "";
    return token;
  }
...
// AR | Arts HU | Humanities SB | Social and Behavioral Sciences,
// NS | Natural Sciences WL | World Languages,
// WC | World Cultures dropdown courses functionality //

 function courseHasSubject(course, subjectCode){
  const wanted = normalizeSubjectCode(subjectCode);
  if(!wanted) return true;

  if(wanted === "AR") {
    return ARTS_SUBJECT_CODES.has(String(course?.code || "").trim().toUpperCase());
  }

if(wanted === "HU") {
  return HUMANITIES_SUBJECT_CODES.has(String(course?.code || "").trim().toUpperCase());
}

if(wanted === "SB") {
  return SBS_SUBJECT_CODES.has(String(course?.code || "").trim().toUpperCase());
}

if(wanted === "NS") {
  return NS_SUBJECT_CODES.has(String(course?.code || "").trim().toUpperCase());
}

if(wanted === "WL") {
  return WL_SUBJECT_CODES.has(String(course?.code || "").trim().toUpperCase());
}

if(wanted === "WC") {
  return WC_SUBJECT_CODES.has(String(course?.code || "").trim().toUpperCase());
}


  const courseSubject = normalizeSubjectCode(getSubjectFromCourseCode(course?.code, course));
  if(courseSubject === wanted) return true;

  const explicitSubject = normalizeSubjectCode(course?.subject || "");
  if(explicitSubject === wanted) return true;

  const codeUpper = upper(course?.code || "");
  const wantedCompact = compactUpper(wanted);

  // Exact subject-prefix match only, so AF does not match AFRSTY
  if(codeUpper.startsWith(wanted + " ")) return true;

  if(Array.isArray(course?.type)) {
    const typeMatches = course.type.some(t => {
      const normalizedType = normalizeSubjectCode(t);
      return normalizedType === wanted || compactUpper(normalizedType) === wantedCompact || upper(t) === wanted;
    });
...
const SUBJECT_NAME_ALIAS_MAP = {
  "ACCOUNTING AND FINANCE": "AF",
  "AFRICANA STUDIES": "AFRSTY",
  ...
  "BIOLOGY": "BIOL",
  "BUSINESS ADMINISTRATION": "BUSADM",
  "ADVANCING AND PROFESSIONAL STUDIES": "CAPS",
  "CHEMISTRY": "CHEM",
  "CHINESE": "CHINSE",
  "CINEMA STUDIES": "CINE",
  "CLASSICS": "CLSICS",
  ...
  "ECONOMICS": "ECON",
  "EDUCATION UNDERGRADUATE": "EDC U",
  "EXERCISE AND HEALTH SCIENCE": "EHS",
  "ENGINEERING": "ENGIN",
  "ENGLISH": "ENGL",
  "ENGLISH PLACEMENT": "ENGLPL",
  "ENVIRONMENTAL SCIENCES": "ENVSCI",
  "ENVIRONMENTAL STUDIES": "ENVSTY",
  "ENGLISH AS A SECOND LANGUAGE": "ESL",
  "STUDENT SUPPORT PROGRAMS COURSE": "FOUN",
  "FRENCH": "FRENCH",
  "GERMAN": "GERMAN",
  "GERONTOLOGY UNDERGRADUATE": "GERON",
  "GLOBAL AFFAIRS": "GLBAFF",
  "GREEK": "GREEK",
  "HISTORY": "HIST",
  "HEALTH": "HLTH",
  "HONORS": "HONORS",
  "HUMANITIES": "HUMAN",
  "HUMAN SERVICES": "HUMCTR",
  "INTERDISCIPLINARY STUDIES": "INTR-D",
  ...
  "NAVITAS STUDY SKILLS": "NAV",
  "NURSING": "NURSNG",
  "PHILOSOPHY": "PHIL",
  "PHILOSOPHY AND LAW": "PHILLAW",
  "PHYSICS": "PHYSIC",
  "POLITICAL SCIENCE": "POLSCI",
  "PORTUGUESE": "PORT",
  "PROFESSIONAL TRAINING": "PRFTRN",
  "PSYCHOLOGY": "PSYCH",
  "PUBLIC HEALTH": "PUBHTH",
  "STUDY OF RELIGION": "RELSTY",
  "RUSSIAN": "RUSS",
  "SUPPLY CHAIN AND SERVICE MANAGEMENT": "SCSM",
  "FRESHMEN SEMINAR": "SEMINR",
  "SOCIOLOGY": "SOCIOL",
  "SPANISH": "SPAN",
  "THEATRE ARTS": "THRART",
  "URBAN PLANNING AND COMMUNITY DEVELOPMENT": "UPCD",
  "UNIVERSITY SEA-BASED SKILLS": "USEA",
  "VIETNAMESE": "VIET",
  "WOMENS GENDER SEXUALITY STUDIES": "WGS"
};

function normalizeSubjectAliasText(value){
  return upper(value)
    .replace(/&/g, ' AND ')
    .replace(/COURSES?$/g, '')
    .replace(/[|]/g, ' ')
...
function resolveSubjectAlias(value){
  const normalized = normalizeSubjectAliasText(value);
  if(!normalized) return '';
  if(SUBJECT_NAME_ALIAS_MAP[normalized]) return SUBJECT_NAME_ALIAS_MAP[normalized];
  for(const [code, display] of Object.entries(SUBJECT_DISPLAY_MAP)){
    const name = (display.split('|')[1] || '').trim();
    if(normalizeSubjectAliasText(name) === normalized) return code;
  }
  return '';
}
...
function setupSubjectDropdown(){
  ...
  const subjects = Object.entries(SUBJECT_DISPLAY_MAP)
    .map(([code, display]) => {
      ...
      return {
        ...
        display,
        name,
        normalizedCode: normalizeSubjectAliasText(code),
        normalizedDisplay: normalizeSubjectAliasText(display),
        normalizedName: normalizeSubjectAliasText(name)
      };
    })
  ...
  function selectSubject(entry){
    ...
    selectedSubjectCode = entry.code;
    hideDropdown();
  ...
  function updateActiveItem(nextIndex){
    ...
    if(activeIndex >= 0 && items[activeIndex]) {
      items[activeIndex].style.background = "var(--line)";
      items[activeIndex].scrollIntoView({ block: "nearest" });
    }
  }

  function renderList(filter=""){
    const f = normalizeSubjectAliasText(filter || "");
    if(lastFilterKey === f) {
      showDropdown();
      return;
    }
    ...
    let filtered = !f
      ? subjects
      : subjects.filter(({ normalizedCode, normalizedDisplay, normalizedName }) => (
          normalizedCode.includes(f) ||
          normalizedDisplay.includes(f) ||
          normalizedName.includes(f)
        ));

    if(f) {
      filtered = filtered.sort((a, b) => {
        const aStarts = Number(a.normalizedCode.startsWith(f) || a.normalizedName.startsWith(f));
        const bStarts = Number(b.normalizedCode.startsWith(f) || b.normalizedName.startsWith(f));
        return bStarts - aStarts || a.display.localeCompare(b.display);
      });
    }

    currentFiltered = filtered.slice(0, MAX_VISIBLE_RESULTS);
    activeIndex = -1;
    dropdown.innerHTML = "";
    ...
    for(const entry of currentFiltered){
      ...
      item.addEventListener("mouseenter", () => {
        updateActiveItem(currentFiltered.indexOf(entry));
      });
      item.addEventListener("mouseleave", () => {
        if(activeIndex >= 0 && dropdown.children[activeIndex]) {
          dropdown.children[activeIndex].style.background = "var(--line)";
        }
      });
  ...
  input.addEventListener("focus", () => scheduleRender(input.value || ""));
  input.addEventListener("input", (e) => {
    const typed = e.target.value || "";
    selectedSubjectCode = normalizeSubjectCode(typed);
  ...
  input.addEventListener("keydown", (e) => {
    ...
    if(e.key === "ArrowDown") {
      e.preventDefault();
      updateActiveItem(activeIndex < currentFiltered.length - 1 ? activeIndex + 1 : 0);
    } else if(e.key === "ArrowUp") {
      e.preventDefault();
      updateActiveItem(activeIndex > 0 ? activeIndex - 1 : currentFiltered.length - 1);
    } else if(e.key === "Enter") {
      if(activeIndex >= 0 && currentFiltered[activeIndex]) {
        e.preventDefault();
        selectSubject(currentFiltered[activeIndex]);
      }
...
function setSubjectFromMajor(majorObj){
  ...
  function isITSignal(text){
    ...
    // Only treat clear IT selections/searches as Information Technology.
    // This avoids false matches like "ITAL | Italian" or words that merely contain "it".
    if(normalized === "information technology") return true;
    if(normalized === "it") return true;
    if(upperRaw === "IT | INFORMATION TECHNOLOGY") return true;
    if(compact === "IT") return true;

    // Match course-code style searches such as "IT 110" or "IT110".
    if(/^IT\s*\d+[A-Z]*$/i.test(raw)) return true;

    // Match IT as a standalone token only, not as part of ITAL/WRITING/etc.
    if(/(^|[^A-Z])IT([^A-Z]|$)/.test(upperRaw)) return true;
...
function renderCourseList(){
  ...
  const subjectInputRaw = subjectSearchInput?.value || "";
  const subjectText = normalize(subjectInputRaw);
  const effectiveSelectedSubjectCode = normalizeSubjectCode(selectedSubjectCode || subjectInputRaw || "");
  ...
  const forceIT =
    ...
    effectiveSelectedSubjectCode === "IT";
  ...
  const filtered = allCourses.filter(c => {
    ...
    const subject = getSubjectFromCourseCode(c.code, c).toLowerCase();
    ...
    const codeCompact = compactUpper(c.code);
    const titleLower = String(c.title || "").toLowerCase();
    const subjectUpper = upper(getSubjectFromCourseCode(c.code, c));
    const subjectUpperCompact = compactUpper(getSubjectFromCourseCode(c.code, c));

    const matchesText =
      qText === "" ? true : (
        codeUpper.includes(qUpper) ||
        codeCompact.includes(qCompact) ||
        titleLower.includes(qText) ||
        (subjectQuery !== "" && subjectUpperCompact.startsWith(subjectQuery))
      );

    const bypassPickers = subjectQuery !== "";

    const subjFilter = effectiveSelectedSubjectCode;
    const hasExplicitSubjectSelection = subjFilter !== "";
      ...
      bypassPickers ? true : (subjFilter === "" ? true : (
        subjFilter === "FYS"
          ...
          : (subjFilter === "IMS"
            ...
            : (
                courseHasSubject(c, subjFilter) &&
                !(subjFilter === "UPCD" && (/^(PCSCOR|CSTCTR)\b/i.test(c.code || "")))
              )
          )
      ));

    const majorSubj = normalizeSubjectCode(demoMajors.find(m => m.name === selectedMajorName)?.subject || "");
    const matchesMajor =
      hasExplicitSubjectSelection ? true : (bypassPickers ? true : (selectedMajorName === "" ? true : courseHasSubject(c, majorSubj)));
  ...
  const sorter =
    window.SS_DB && typeof window.SS_DB.sortCoursesBySubjectAndNumber === "function"
      ? window.SS_DB.sortCoursesBySubjectAndNumber
      : (arr => arr);

  const displayCourses = sorter(deduped);

  elCourseList.innerHTML = displayCourses.map(c => {
  ...
  // BUTTONS
  // =====================================================
  const DASHBOARD_STORAGE_KEY = "aps_dashboard_plan_v1";
  ...
  function clearDashboardState(){
    try{
      ...
      console.warn("Dashboard clear failed:", err);
      return false;
    }
  }
  ...
  if(clearBtn){
    clearBtn.addEventListener("click", () => {
      ...
      renderPlan();
      if(prereqHintEl){
        prereqHintEl.textContent = "";
      }
    });
  }

  function getDashboardState(){
    const earned = earnedInput ? parseInt(earnedInput.value || "0", 10) : 0;
    const needed = neededInput ? parseInt(neededInput.value || "120", 10) : 120;
    return {
      planCodes: Array.isArray(plan) ? plan.map(c => c && c.code).filter(Boolean) : [],
      selectedMajorName,
      selectedSubjectCode,
      selectedTrackName,
      courseSearch: elSearch ? (elSearch.value || "") : "",
      subjectSearch: subjectSearchInput ? (subjectSearchInput.value || "") : "",
      majorSearch: majorSearchInput ? (majorSearchInput.value || "") : "",
      trackSearch: trackSearchInput ? (trackSearchInput.value || "") : "",
      creditFilter: creditFilterInput ? (creditFilterInput.value || "") : "",
      earned: Number.isFinite(earned) ? earned : 0,
      needed: Number.isFinite(needed) && needed > 0 ? needed : 120,
      savedAt: new Date().toISOString()
    };
  }

  function saveDashboardState(showMessage = false){
    try{
      const payload = getDashboardState();
      localStorage.setItem(DASHBOARD_STORAGE_KEY, JSON.stringify(payload));
      if(prereqHintEl && showMessage){
        const stamp = new Date(payload.savedAt).toLocaleString();
        prereqHintEl.textContent = `Plan saved in this browser on ${stamp}.`;
      }
      return payload;
    }catch(err){
      console.warn("Dashboard save failed:", err);
      if(showMessage) alert("Unable to save this plan in the browser.");
      return null;
    }
  }
  ...
  function restoreDashboardState(){
    try{
      ...
      const courseMap = new Map((allCourses || []).map(c => [String(c.code || "").trim().toUpperCase(), c]));
      plan = Array.isArray(saved.planCodes)
        ? saved.planCodes.map(code => courseMap.get(String(code || "").trim().toUpperCase())).filter(Boolean)
        : [];

      selectedMajorName = String(saved.selectedMajorName || "").trim();
      selectedSubjectCode = String(saved.selectedSubjectCode || "").trim();
      selectedTrackName = String(saved.selectedTrackName || "").trim();

      if(elSearch) elSearch.value = saved.courseSearch || "";
      if(subjectSearchInput) subjectSearchInput.value = saved.subjectSearch || "";
      if(majorSearchInput) majorSearchInput.value = saved.majorSearch || "";
      if(trackSearchInput) trackSearchInput.value = saved.trackSearch || "";
      if(creditFilterInput) creditFilterInput.value = saved.creditFilter || "";
      if(earnedInput) earnedInput.value = Number.isFinite(saved.earned) ? saved.earned : (parseInt(saved.earned, 10) || 0);
      if(neededInput) neededInput.value = Number.isFinite(saved.needed) ? saved.needed : (parseInt(saved.needed, 10) || 120);

      renderCourseList();
      renderPlan();
      if(typeof updateCreditDonut === "function") updateCreditDonut();

      if(prereqHintEl && saved.savedAt){
        prereqHintEl.textContent = `Restored your saved browser plan from ${new Date(saved.savedAt).toLocaleString()}.`;
      }
      return true;
    }catch(err){
      console.warn("Dashboard restore failed:", err);
      return false;
    }
  }
  ...
  if(saveBtn){
    saveBtn.addEventListener("click", () => {
      const saved = saveDashboardState(true);
      if(saved){
        alert("Plan saved in this browser.");
      }
    });
  }

  async function saveDashboardScreenshot(){
    const dashboardTarget = document.getElementById("semesterPlanSection") || document.querySelector('section[aria-label="Semester Plan"]') || document.querySelector(".plan");
    if(!dashboardTarget) {
      alert("Semester Plan area not found.");
      return;
    }
    ...
    const footerBtns = dashboardTarget.querySelector(".footerBtns");
    const originalText = shotBtn ? shotBtn.textContent : "";
    const originalFooterDisplay = footerBtns ? footerBtns.style.display : "";
    if(shotBtn){
    ...
    try{
      const canvas = await window.html2canvas(dashboardTarget, {
        backgroundColor: getComputedStyle(dashboardTarget).backgroundColor || getComputedStyle(document.body).backgroundColor || "#ffffff",
      ...
      link.download = `aps-semester-plan-${stamp}.png`;
      document.body.appendChild(link);
      link.click();
      link.remove();
      if(prereqHintEl){
        prereqHintEl.textContent = "Semester Plan screenshot downloaded as PNG.";
      }
    }catch(err){
      console.warn("Dashboard screenshot failed:", err);
      alert("Could not create the screenshot on this browser.");
    }finally{
      if(footerBtns){
        footerBtns.style.display = originalFooterDisplay;
      }
      if(shotBtn){
        shotBtn.disabled = false;
        shotBtn.textContent = originalText || "Save Screenshot";
      }
    }
  }
  ...
  const shotBtn = document.getElementById("shotBtn");
  if(shotBtn){
    shotBtn.addEventListener("click", saveDashboardScreenshot);
  }
...
if (yearInput && clearYear) {
  yearInput.addEventListener("input", () => {
    clearYear.style.display = yearInput.value ? "block" : "none";
  });

  clearYear.addEventListener("click", () => {
    yearInput.value = "";
    clearYear.style.display = "none";
    yearInput.focus();
  });
}
...
// =====================================================
function setupSubjectDropdownLegacy_DO_NOT_USE() {
  const input =
    document.getElementById("subjectSearchInput") ||
    document.getElementById("subjectSearch");
...
function sortCoursesBySubjectAndNumber(courses) {
  const getSubject = (course) => {
    const raw = String(course?.code || "").trim();
    if (!raw) return "";
    if (raw.toUpperCase().startsWith("EDC U ")) return "EDC U";
    const parts = raw.split(/\s+/);
    if (parts.length >= 2 && parts[0].toUpperCase() === "EDC" && parts[1].toUpperCase() === "U") {
      return "EDC U";
    }
...
window.SS_DB.allCourses = uniqByCode([
  ...(window.SS_DB.allCourses || []),
  ...allCourses
]);

window.SS_DB.demoMajors = demoMajors;
window.SS_DB.subjectCatalog = subjectCatalog;
window.SS_DB.trackMajorOptions = trackMajorOptions;
window.SS_DB.trackOptionsByMajor = trackOptionsByMajor;
window.SS_DB.courseHasSubject = courseHasSubject;
window.SS_DB.sortCoursesBySubjectAndNumber = sortCoursesBySubjectAndNumber;
